                  ...
                  onPressed: () async {
                    DateTime? newDateTime = await showRoundedDatePicker(
                      ...
                      theme: ThemeData(
                        ...
                        colorScheme: ColorScheme.fromSwatch().copyWith(secondary: Colors.green[800]),
                      ),
                    );
                    setState(() => dateTime = newDateTime!);
                  },
                ...
                FloatingActionButton.extended(
                  onPressed: () {
                    CupertinoRoundedDatePicker.show(
                      ...
                      background: Colors.red.shade300, //Colors.red[300],
                      borderRadius: 16,
                ...
                FloatingActionButton.extended(
                  onPressed: () async {
                    CupertinoRoundedDatePicker.show(
                      ...
                      fontFamily: "Mali",
                      textColor: Colors.white,
                      background: Colors.green.shade300, //Colors.green[300],
                      onDateTimeChanged: (newDateTime) {
                        setState(() => dateTime = newDateTime);
                      },
                    );
